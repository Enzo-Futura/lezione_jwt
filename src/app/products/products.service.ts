...
@Injectable({// è un decoratore , viene creato in automatico alla creazione del "service".
  providedIn: 'root'// servizio
})
export class ProdcutsService {
  ...
  getProducts(): Observable<Product[]> {
    ...
    }).pipe( //"pipe" permette di elaborare i dati di una sequenza
  ...
  private getProductFromProductDTO(productDTO: ProductDTO):Product { // private non rende visibile la funzione
    return {
      id: productDTO.id,
